...
router.get('/oauth/redirect', (req, res) => {
  ...
  axios({
    method: 'post',
    url: `https://sandbox-api.dexcom.com/v2/oauth2/token?client_secret=${clientSecret}&client_id=${clientID}&code=${requestToken}&grant_type=authorization_code&redirect_uri=${clientURI}`,
    headers: {
